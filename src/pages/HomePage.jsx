...
const stats = [
  { numEN: '44+', numAR: '+44', labelKey: 'yearsExcellence' },
  { numEN: '12,000+', numAR: '+12,000', labelKey: 'graduates' },
  { numEN: '180+', numAR: '+180', labelKey: 'faculty' },
  { numEN: '24+', numAR: '+24', labelKey: 'programs' },
];

const newsItems = [1, 2, 3].map(i => ({
  titleKey: `news${i}Title`,
  dateKey: `news${i}Date`,
  excerptKey: `news${i}Excerpt`,
  img: [
    ...
    <main className="home-page">
          ...
          <div className="about-grid">
            <div className="about-images reveal-left">
              <div className="about-img-main">
                <img src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800&q=85" alt="Students" />
              </div>
              <div className="about-img-accent">
                <img src="https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=600&q=85" alt="School building" />
              </div>
              <div className="about-img-badge">
                <div className="badge-year">1980</div>
          ...
          <div className="founder-inner">
            <div className="founder-portrait reveal-left">
              <div className="portrait-frame">
                <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=500&q=85" alt="Founder" />
              </div>
      ...
      <section className="news-preview">
        <div className="container">
          <div className="news-header reveal">
            <div>
              <span className="section-label">{txt.newsLabel}</span>
              <h2 className="section-title">{txt.newsTitle}</h2>
              <div className="section-divider" />
            </div>
          ...
          <div className="news-grid">
            {newsItems.map((item, i) => (
              <article className={`news-card reveal delay-${i + 1}`} key={i}>
                ...
                <div className="news-card-body">
                  ...
                  <h3 className="news-card-title">{txt[item.titleKey]}</h3>
                  <p className="news-card-excerpt">{txt[item.excerptKey]}</p>
      ...
      <section className="admissions-cta">
        <div className="admissions-cta-bg">
          <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=1600&q=80" alt="Admissions" />
